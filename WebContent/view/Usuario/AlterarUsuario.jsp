						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="email" class="form-control" name="email" id="email" autofocus=""  value="${usuario.email}" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="password" class="form-control" name="senha" id="senha" autofocus=""  value="${usuario.senha}" />
								</div>
							</div>
						</div>
